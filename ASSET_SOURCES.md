...
| Nature models (`assets/models/nature/*.glb`) — detailed trees, pines, bushes you can stand in, stumps, logs, grass tufts, flowers, mushrooms, rocks; self-contained materials, no shared colormap | Kenney | https://kenney.nl/assets/nature-kit | Kenney | CC0 1.0 | Yes | Yes | Not required |
