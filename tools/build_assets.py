...
MODELS = {
    ...
    "nature": ("3d/nature-kit/Models/GLTF format", [
        # Trees, in enough variants that a 90x90 map never reads as one tree
        # copy-pasted, plus dark and autumn sets for the second chapter.
        "tree_default", "tree_default_dark", "tree_default_fall",
        "tree_oak", "tree_oak_dark", "tree_oak_fall",
        "tree_detailed", "tree_detailed_dark", "tree_detailed_fall",
        "tree_tall", "tree_tall_dark", "tree_thin", "tree_thin_dark",
        "tree_fat", "tree_blocks", "tree_blocks_dark", "tree_simple", "tree_simple_dark",
        "tree_small", "tree_small_dark", "tree_plateau", "tree_plateau_dark",
        "tree_pineDefaultA", "tree_pineDefaultB", "tree_pineGroundA", "tree_pineGroundB",
        ...
        "flower_yellowA", "flower_yellowB",
        "mushroom_red", "mushroom_redGroup", "mushroom_redTall",
        # Rocks and boulders: the hills scattered through the map.
        ...
        "rock_tallF", "rock_tallG", "rock_tallH", "rock_tallI", "rock_tallJ",
        "rock_smallA", "rock_smallB", "rock_smallC", "rock_smallD", "rock_smallE",
        "rock_smallFlatA", "rock_smallFlatB", "rock_smallTopA",
        "stone_largeA", "stone_largeB", "stone_largeC", "stone_largeD",
        "stone_tallA", "stone_tallC", "stone_tallE", "stone_tallG", "stone_tallI",
        "stone_smallA", "stone_smallC", "stone_smallFlatA",
        # Cliffs: stacked into the mountain range on the horizon.
        "cliff_rock", "cliff_stone", "cliff_large_rock", "cliff_large_stone",
        "cliff_block_rock", "cliff_block_stone", "cliff_blockSlope_rock",
        "cliff_blockHalf_rock", "cliff_blockQuarter_rock",
        "cliff_cornerLarge_rock", "cliff_cornerLarge_stone", "cliff_corner_rock",
        "cliff_top_rock", "cliff_top_stone", "cliff_cave_rock", "cliff_waterfall_rock",
        "cliff_half_rock", "cliff_diagonal_rock", "cliff_steps_rock",
        # Ground dressing: worn stone paths and river tiles.
        "ground_pathTile", "ground_pathStraight", "ground_pathBend", "ground_pathCorner",
        "ground_pathRocks", "ground_grass",
        "path_stone", "path_stoneCircle", "path_stoneCorner", "path_wood",
        # Deadfall and camp props.
        "log", "log_large", "log_stack", "log_stackLarge",
        "stump_round", "stump_roundDetailed", "stump_old", "stump_oldTall",
        "stump_square", "stump_squareDetailed",
        "campfire_logs", "campfire_stones", "campfire_bricks",
        "fence_simple", "fence_simpleLow", "fence_planks", "fence_bend",
        "statue_obelisk", "statue_column", "statue_columnDamaged", "statue_head", "statue_ring",
        "tent_detailedOpen", "tent_smallClosed",
        "crops_wheatStageB", "crops_cornStageC",
    ]),
